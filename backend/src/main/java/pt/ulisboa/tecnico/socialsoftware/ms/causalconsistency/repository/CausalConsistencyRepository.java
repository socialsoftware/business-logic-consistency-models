package pt.ulisboa.tecnico.socialsoftware.ms.causalconsistency.repository;
...
@Repository
@Transactional
public interface CausalConsistencyRepository extends JpaRepository<Aggregate, Integer> {
