...
@Entity
public class QuizAnswerTCC extends QuizAnswer implements CausalConsistency {
    public QuizAnswerTCC() {
        super();
    }

    public QuizAnswerTCC(Integer aggregateId, AnswerCourseExecution answerCourseExecution, AnswerStudent answerStudent, AnsweredQuiz answeredQuiz) {
        super(aggregateId, answerCourseExecution, answerStudent, answeredQuiz);
    }

    public QuizAnswerTCC(QuizAnswerTCC other) {
        super(other);
    }
    ...
    public Aggregate mergeFields(Set<String> toCommitVersionChangedFields, Aggregate committedVersion, Set<String> committedVersionChangedFields) {
        QuizAnswerTCC toCommitQuizAnswer = new QuizAnswerTCC(this);
        QuizAnswerTCC committedQuizAnswer = (QuizAnswerTCC) committedVersion;
