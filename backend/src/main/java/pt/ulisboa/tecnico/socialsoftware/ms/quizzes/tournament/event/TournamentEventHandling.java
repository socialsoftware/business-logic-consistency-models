package pt.ulisboa.tecnico.socialsoftware.ms.quizzes.tournament.event;
    ...
    public void handleUnenrollStudentFromCourseExecutionEvents() {
        ...
        for (Integer subscriberAggregateId : tournamentAggregateIds) {
            ...
            for (EventSubscription eventSubscription: eventSubscriptions) {
                ...
                for (Event eventToProcess : eventsToProcess) {
                    tournamentEventProcessing.processUnenrollStudentEvent(subscriberAggregateId, (UnerollStudentFromCourseExecutionEvent) eventToProcess);
                }
            }
        }
    }
